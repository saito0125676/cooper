...
export default function Home() {
  return (
    <div className={styles.homePage}>
        ...
        <div className={styles.pageScrim} aria-hidden="true" />
        ...
        <section className={styles.hero}>
          <div className={styles.heroInner}>
            ...
            <p className={styles.heroSub}>
              全長3メートルの小さな車で、宮古島を一周してみてください。サトウキビ畑の間の細い道も、集落の狭い角も、この車なら曲がれます。1日から貸し出しています。
            </p>
            <div className={styles.heroActions}>
              <Link className={`${styles.btn} ${styles.btnSolid}`} href="/booking">
                空きを問い合わせる
              </Link>
              <a className={`${styles.btn} ${styles.btnLine}`} href="#cars">
                2台を見る
              </a>
            </div>
          </div>
        ...
        {/* 車種 */}
        <section className={`${styles.band} ${styles.bandPaper}`} id="cars">
        ...
        {/* ルート */}
        <section className={`${styles.band} ${styles.bandGreen}`}>
          <div className={styles.bandInner}>
            <div className={styles.secHead}>
        ...
        {/* 予約 */}
        <section className={`${styles.band} ${styles.bandGreen}`} id="book">
          <div className={`${styles.bandInner} ${styles.ctaWrap}`}>
            <span className={`${styles.eyebrow} ${styles.eyebrowCta}`}>RESERVATION</span>
            <h2 className={styles.secTitle}>オンラインで予約する</h2>
            <p className={styles.ctaHours} style={{ marginTop: "1rem" }}>
              空き状況の確認から決済まで、その場で完了します
            </p>
            ...
            <p className={styles.ctaHours} style={{ marginTop: "2.2rem" }}>
              お電話でのご予約はこちら
            </p>
